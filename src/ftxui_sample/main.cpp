...
// configuration step. It creates a namespace called `jupiter`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", jupiter::cmake::project_name, jupiter::cmake::project_version) };
